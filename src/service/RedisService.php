...
class RedisService
{
    ...
    {
        static::instance()->connect(config('cache.stores.redis.host'), config('cache.stores.redis.port'));
        static::instance()->auth(config('cache.stores.redis.password'));
        return static::$instance;
    }
